...
interface MangaRepository {
    ...
    /**
     * Refresh the library cache for many manga in a single DB transaction.
     * Avoids the per-id transaction storm of calling [refreshLibraryCacheForManga] in a loop.
     */
